(function () {
  ...
  app.innerHTML = `<section class="campaign-intro"><div><p class="eyebrow">Microsoft cloud security decision map</p><h2>From current conditions to a defensible campaign.</h2><p>Choose the closest answers. Unknowns stay visible as discovery work, while the roadmap orders prerequisites and links to the specialist setup hubs.</p></div></section>
