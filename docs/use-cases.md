...
**Core control path:** [Microsoft Defender for Office 365](https://cloud2br-msftlearninghub.github.io/Defender-Setup-Overview/microsoft-ecosystem/defender-for-office-365/) for reporting,
investigation, and remediation; [Microsoft Entra ID Protection](https://cloud2br-msftlearninghub.github.io/Defender-Setup-Overview/microsoft-ecosystem/entra-id-protection/) and [Conditional
Access](https://cloud2br-msftlearninghub.github.io/Entra-Overview/secure/conditional-access-and-authentication/) for risky identity follow-up; [Microsoft Defender for Endpoint](https://cloud2br-msftlearninghub.github.io/Defender-Setup-Overview/microsoft-ecosystem/defender-for-endpoint/) when the
user opened a file or link; [Microsoft Sentinel](https://cloud2br-msftlearninghub.github.io/Sentinel-Setup-Overview/detection-and-response/automation-and-playbooks/) when the organization needs
...
| --- | --- | --- |
| Data types and regulations, business owners, Microsoft 365 locations, endpoints, SaaS applications, cloud storage, current labels, and known exceptions | Define sensitive information types and, where justified, trainable classifiers; create sensitivity labels; configure [DLP](https://cloud2br-msftlearninghub.github.io/Purview-Setup-Overview/protection/data-loss-prevention/) policies in simulation; add [Endpoint DLP](https://cloud2br-msftlearninghub.github.io/Purview-Setup-Overview/protection/data-loss-prevention/) for USB, print, browser, and untrusted-cloud actions | Detection matches the intended PII, policy hits have business-owner review, exceptions are time-bound and approved, and users receive understandable policy tips |

**Core control path:** [Microsoft Purview Information Protection](https://cloud2br-msftlearninghub.github.io/Purview-Setup-Overview/protection/information-protection/) and [DLP](https://cloud2br-msftlearninghub.github.io/Purview-Setup-Overview/protection/data-loss-prevention/) for
classification and prevention; [Endpoint DLP](https://cloud2br-msftlearninghub.github.io/Purview-Setup-Overview/protection/data-loss-prevention/) for local-device movement; [Microsoft
Defender for Cloud Apps](https://cloud2br-msftlearninghub.github.io/Defender-Setup-Overview/microsoft-ecosystem/defender-for-cloud-apps/) for sanctioned/unsanctioned SaaS discovery and monitoring;
[Microsoft Sentinel](https://cloud2br-msftlearninghub.github.io/Sentinel-Setup-Overview/detection-and-response/analytics-rules/) for correlation with identity or data-access signals.

**Implementation example:** Begin with one high-value data type, such as customer
payment details. Run a [DLP](https://cloud2br-msftlearninghub.github.io/Purview-Setup-Overview/protection/data-loss-prevention/) policy in simulation for four weeks across Exchange,
...
| What to gather | Technical actions to plan | Validate before closing the use case |
| --- | --- | --- |
| User, timestamps, IP addresses, device IDs, sign-in and audit logs, MFA method changes, [Conditional Access](https://cloud2br-msftlearninghub.github.io/Entra-Overview/secure/conditional-access-and-authentication/) results, privileged roles, and applications accessed | Review risky users and sign-ins; revoke sessions when compromise is credible; reset credentials and verify MFA methods; review mailbox rules, OAuth consent, and privileged-role activations; hunt for related sign-ins | The identity has a known owner, sessions and high-risk tokens are addressed, MFA methods are verified, privileged access is reviewed, and the user/device receives a clean bill of health or a documented remediation plan |

**Core control path:** [Microsoft Entra ID Protection](https://cloud2br-msftlearninghub.github.io/Defender-Setup-Overview/microsoft-ecosystem/entra-id-protection/) for risk signals, [Entra
Conditional Access](https://cloud2br-msftlearninghub.github.io/Entra-Overview/secure/conditional-access-and-authentication/) for risk-based access decisions and trusted-device
requirements, [Defender for Endpoint](https://cloud2br-msftlearninghub.github.io/Defender-Setup-Overview/microsoft-ecosystem/defender-for-endpoint/) for device context, and [Sentinel](https://cloud2br-msftlearninghub.github.io/Sentinel-Setup-Overview/detection-and-response/analytics-rules/) for
...
**Core control path:** [Microsoft Defender for Endpoint](https://cloud2br-msftlearninghub.github.io/Defender-Setup-Overview/microsoft-ecosystem/defender-for-endpoint/) for detection,
investigation, and device containment; [Microsoft Defender for Cloud](https://cloud2br-msftlearninghub.github.io/Defender-Setup-Overview/cloud/defender-cspm/) for server
and workload posture where relevant; [Microsoft Sentinel](https://cloud2br-msftlearninghub.github.io/Sentinel-Setup-Overview/detection-and-response/incidents-and-investigation/) for incident
...
**Core control path:** [Microsoft Defender for Cloud Apps](https://cloud2br-msftlearninghub.github.io/Defender-Setup-Overview/microsoft-ecosystem/defender-for-cloud-apps/) for SaaS discovery,
activity visibility, and governance; [Microsoft Purview](https://cloud2br-msftlearninghub.github.io/Purview-Setup-Overview/protection/data-loss-prevention/) for sensitive-data
classification and DLP; [Microsoft Entra](https://cloud2br-msftlearninghub.github.io/Entra-Overview/secure/conditional-access-and-authentication/) for access and session controls;
[Microsoft Sentinel](https://cloud2br-msftlearninghub.github.io/Sentinel-Setup-Overview/data-and-content/data-connectors/) for log correlation, detection, and incident response.
...
**Core control path:** [Microsoft Defender for Office 365](https://cloud2br-msftlearninghub.github.io/Defender-Setup-Overview/microsoft-ecosystem/defender-for-office-365/) for impersonation and
mail investigation; [Microsoft Entra](https://cloud2br-msftlearninghub.github.io/Entra-Overview/secure/conditional-access-and-authentication/) for strong authentication and risky-sign-in
follow-up; Exchange Online for mailbox permission and forwarding review;
[Microsoft Sentinel](https://cloud2br-msftlearninghub.github.io/Sentinel-Setup-Overview/detection-and-response/incidents-and-investigation/) for cross-signal investigation where payment-fraud cases need
...
| What to gather | Technical actions to plan | Validate before closing the use case |
| --- | --- | --- |
| Role assignments, activation history, approvals, administrator sign-ins, [device compliance](https://cloud2br-msftlearninghub.github.io/Intune-Overview/implementation/compliance-and-conditional-access/), emergency-access records, service principals, and affected resources | Inventory permanent privileged roles; require just-in-time elevation with approval for high-impact roles; separate daily and administrator accounts; protect privileged access with [Conditional Access](https://cloud2br-msftlearninghub.github.io/Entra-Overview/secure/conditional-access-and-authentication/) and phishing-resistant authentication; alert on role changes and emergency-account use | Every broad role has a business owner and review cadence, just-in-time access is tested for a pilot role, emergency accounts are controlled and monitored, and the team can trace a high-impact administrative change to an approved identity and ticket |

**Core control path:** [Microsoft Entra Privileged Identity Management](https://cloud2br-msftlearninghub.github.io/Entra-Overview/secure/privileged-access-and-rbac/) for
eligible assignments, approvals, activation, and access reviews; [Conditional
Access](https://cloud2br-msftlearninghub.github.io/Entra-Overview/secure/conditional-access-and-authentication/) and [device compliance](https://cloud2br-msftlearninghub.github.io/Intune-Overview/implementation/compliance-and-conditional-access/) for privileged sign-ins; [Microsoft Sentinel](https://cloud2br-msftlearninghub.github.io/Sentinel-Setup-Overview/detection-and-response/analytics-rules/) for
...
| --- | --- | --- |
| Business owner, intended users, data sources, permissions, connected actions, sensitivity labels, retention requirements, audit events, human approval points, and rollback owner | Use a dedicated least-privilege identity; restrict agent data sources to an approved subset; apply [Purview labels](https://cloud2br-msftlearninghub.github.io/Purview-Setup-Overview/protection/sensitivity-labels/) and [DLP](https://cloud2br-msftlearninghub.github.io/Purview-Setup-Overview/protection/data-loss-prevention/) where appropriate; require human approval for consequential actions; log prompts, actions, and failures in the approved operational system | A pilot demonstrates the agent cannot access unapproved data or perform unapproved actions, audit evidence identifies the user and agent activity, data owners approve the boundary, and the team can disable or roll back the integration quickly |

**Core control path:** [Microsoft Entra](https://cloud2br-msftlearninghub.github.io/Entra-Overview/secure/external-and-workload-identities/) workload identities and least-privilege
permissions; [Microsoft Purview](https://cloud2br-msftlearninghub.github.io/Purview-Setup-Overview/protection/information-protection/) for data classification and protection; [Microsoft
Defender](https://cloud2br-msftlearninghub.github.io/Defender-Setup-Overview/microsoft-ecosystem/defender-xdr/) and [Sentinel](https://cloud2br-msftlearninghub.github.io/Sentinel-Setup-Overview/operations/defender-integration/) for monitoring relevant identity, endpoint, cloud, and data
